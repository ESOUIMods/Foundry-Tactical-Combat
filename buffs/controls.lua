...
function FTC.Buffs:Controls()
  ...
  pb.label = FTC.UI:Label("FTC_PlayerBuffs_Label", pb, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_PB_Label), true)
  ...
  pd.label = FTC.UI:Label("FTC_PlayerDebuffs_Label", pd, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_PD_Label), true)
  ...
  lb.label = FTC.UI:Label("FTC_LongBuffs_Label", lb, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_LB_Label), true)
  ...
  td.label = FTC.UI:Label("FTC_TargetDebuffs_Label", td, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_TD_Label), true)
  td:SetMovable(true)
  ...
  tb.label = FTC.UI:Label("FTC_TargetBuffs_Label", tb, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_TB_Label), true)
  tb:SetMovable(true)
