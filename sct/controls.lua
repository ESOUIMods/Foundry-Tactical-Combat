...
function FTC.SCT:Controls()
  ...
  CTO.label = FTC.UI:Label("FTC_SCTOut_Label", CTO, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_OD_Label), true)
  ...
  CTI.label = FTC.UI:Label("FTC_SCTIn_Label", CTI, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_ID_Label), true)
  ...
  CTA.label = FTC.UI:Label("FTC_SCTAlerts_Label", CTA, "inherit", { CENTER, CENTER, 0, 0 }, FTC.UI:Font("Trajan Pro", 24, true), nil, { 1, 1 }, GetString(FTC_CA_Label), true)
