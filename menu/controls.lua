...
function FTC.Menu:Controls()
  ...
  if FTC.Vars.EnableFrames then
    ...
    FTC.Menu.options[#FTC.Menu.options + 1] = {
      ...
      choices = FTC.UI.fontListChoices,
  ...
  if FTC.Vars.EnableBuffs then
    ...
    FTC.Menu.options[#FTC.Menu.options + 1] = {
      ...
      choices = FTC.UI.fontListChoices,
      getFunc = function() return FTC.Vars.BuffsFont1 end,
      setFunc = function(value) 
        FTC.Vars.BuffsFont1 = value
        FTC.Menu:UpdateBuffs("BuffsFont1", FTC.Vars.BuffsFont1) 
      end,
